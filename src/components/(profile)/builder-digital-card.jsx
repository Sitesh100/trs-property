    ...
    return (
        <>
            <div className="mb-6 rounded-xl border border-[#2a1f45]/20 bg-[#f8f7fb] p-4">
                <p className="text-sm text-gray-700">Builder Profile as Digital Card</p>
                        ...
                        <div className="relative w-full max-w-md rounded-2xl border border-white/20 bg-linear-to-br from-[#2a1f45] via-[#1f1534] to-[#111] p-5 text-white shadow-2xl">
                            ...
                            <div className="mb-5 flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    {profile.city && <p className="text-xs text-gray-300">{profile.city}</p>}
                                </div>
                            </div>

                            <div className="space-y-2 rounded-xl border border-white/15 bg-black/20 p-3 text-sm">
                                {profile.rera && <p className="text-gray-200">RERA: {profile.rera}</p>}
                                {profile.phone && (
                                ...
                                {profile.website && (
                                    <a href={profile.website} target="_blank" rel="noreferrer" className="flex items-center justify-between rounded-md px-2 py-1 hover:bg-white/10">
                                        <span>Website</span>
                                        <ExternalLink size={13} />
                                    </a>
                                )}
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-2">
                                ...
                                <button
                                    type="button"
                                    onClick={shareCard}
                                    className="inline-flex items-center justify-center gap-2 rounded-md bg-white px-3 py-2 text-sm font-semibold text-[#2a1f45] hover:bg-gray-100"
                                >
