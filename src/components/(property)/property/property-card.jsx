...
//     const customerQuery = useGetCustomerPropertyQuery(undefined, {
//         skip: !token,
//     });
//     const publicQuery = useGetPropertyQuery(undefined, {
//         skip: token,
//     });
//     const data = token ? customerQuery?.data : publicQuery?.data;
//     const isLoading = token ? customerQuery?.isLoading : publicQuery?.isLoading;
        ...
        <>
            ...
            <div className="container mx-auto md:px-10 px-5">
                <div className="flex justify-between my-8 items-center">
                    <h1 className='md:text-3xl text-lg font-bold'>All Properties on RX100</h1>
                </div>
