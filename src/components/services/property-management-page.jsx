...
function PropertyManagementPage() {
  return (
    <>
      <Header />
      <main className="bg-[#212121] text-[#F5EFE7] min-h-screen">
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-start">
            <div>
              ...
              <div className="mt-8 space-y-5 text-[#F5EFE7] text-base sm:text-lg leading-relaxed max-w-xl">
                <p>
              ...
              {serviceItems.map((item) => (
                <div key={item.id}>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-3xl font-light text-[#F5EFE7]/95">{item.id}</span>
                    <span className="text-3xl text-[#F5EFE7]/60 leading-none">|</span>
                    <h2 className="text-2xl sm:text-[2rem] font-medium tracking-tight">{item.title}</h2>
                  </div>
                  <p className="text-[#F5EFE7] text-base sm:text-lg leading-relaxed max-w-2xl pl-11">{item.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="relative py-10 sm:py-14">
          <div
            ...
            aria-hidden="true"
          />
          <div className="absolute inset-0 bg-[#212121]/65" aria-hidden="true" />

          <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
            <div className="bg-[#212121]/95 border border-[#F5EFE7]/10 rounded-none sm:rounded-md px-8 sm:px-14 py-10 sm:py-14 grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="lg:pl-8">
                <p className="text-[#F5EFE7] text-base sm:text-lg leading-relaxed max-w-lg mb-6">
                  End-to-end management designed to protect your asset, streamline operations, and deliver consistent performance.
                </p>
                <button className="bg-[#F5EFE7] text-[#212121] hover:bg-[#212121] text-base font-semibold rounded-lg px-6 py-3 transition-colors">
                  Contact Us
                </button>
              </div>
            </div>
